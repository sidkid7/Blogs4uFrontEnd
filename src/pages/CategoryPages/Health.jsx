...
const Health = () => {
  ...
  const changePage = (pageNumber = 0, pageSize = 5) => {
    ...
    loadPostByCat(7, pageNumber, pageSize)
      .then((data) => {
        setPostContent({
        ...
        <Row>
          ...
          >
            <div className="d-flex align-items-center justify-content-center justify-content-md-start">
              ...
              >
                <DropdownToggle caret color="white"  className="categorySelect">Health( {postContent?.totalElements} )</DropdownToggle>
                <DropdownMenu className="dropMenu" >
                  <DropdownItem header>Health</DropdownItem>
