...
const  Financial = () => {
  ...
  const changePage = (pageNumber = 0, pageSize = 5) => {
    ...
    loadPostByCat(5, pageNumber, pageSize)
      .then((data) => {
        setPostContent({
        ...
        <Row>
          ...
          >
            <div className="d-flex align-items-center justify-content-center justify-content-md-start">
              ...
              >
                <DropdownToggle caret color="white"  className="categorySelect">Financial ( {postContent?.totalElements} )</DropdownToggle>
                <DropdownMenu className="dropMenu" >
                  <DropdownItem header>Financial</DropdownItem>
